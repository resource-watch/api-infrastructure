...
// /v1/aqueduct
data "aws_api_gateway_resource" "v1_aqueduct_resource" {
...
resource "aws_api_gateway_resource" "v1_aqueduct_analysis_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_aqueduct_resource.id
  path_part   = "analysis"
}
...
module "aqueduct_analysis_get_v1_aqueduct_analysis" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/aqueduct/analysis"
...
module "aqueduct_analysis_get_v1_aqueduct_analysis_cba" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/aqueduct/analysis/cba"
  vpc_link       = var.vpc_link
}
...
module "aqueduct_analysis_get_v1_aqueduct_analysis_cba_default" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/aqueduct/analysis/cba/default"
  vpc_link       = var.vpc_link
}
...
module "aqueduct_analysis_get_v1_aqueduct_analysis_cba_widget_id" {
  ...
  method       = "GET"
  uri          = "http://api.resourcewatch.org:30502/api/v1/aqueduct/analysis/cba/widget/{widgetId}"
  vpc_link     = var.vpc_link
}

module "aqueduct_analysis_get_v1_aqueduct_analysis_cba_expire_cache" {
  source       = "../endpoint"
  api_gateway  = var.api_gateway
  api_resource = aws_api_gateway_resource.v1_aqueduct_analysis_cba_expire_cache_resource
  method       = "GET"
  uri          = "http://api.resourcewatch.org:30502/api/v1/aqueduct/analysis/cba/expire-cache"
  vpc_link     = var.vpc_link
}

module "aqueduct_analysis_delete_v1_aqueduct_analysis_risk_widget_id" {
  source       = "../endpoint"
  api_gateway  = var.api_gateway
  api_resource = aws_api_gateway_resource.v1_aqueduct_analysis_risk_widget_id_resource
  method       = "DELETE"
  backend_method = "POST"
  uri          = "http://api.resourcewatch.org:30502/api/v1/aqueduct/analysis/risk/widget/{widgetId}"
  vpc_link     = var.vpc_link
}
