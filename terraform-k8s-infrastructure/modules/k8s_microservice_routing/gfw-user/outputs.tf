output "endpoints" {
  value = [
    ...
    module.gfw_user_any_v2_user_proxy.endpoint_gateway_integration,
    module.gfw_user_get_v2_user.endpoint_gateway_integration,
    module.gfw_user_post_v2_user.endpoint_gateway_integration,
  ]
}