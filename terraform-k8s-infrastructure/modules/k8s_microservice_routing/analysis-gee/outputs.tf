output "endpoints" {
  value = [
    ...
    module.analysis_gee_any_v1_landsat_tiles_proxy.endpoint_gateway_integration,
    module.analysis_gee_any_v2_landsat_tiles_proxy.endpoint_gateway_integration,
