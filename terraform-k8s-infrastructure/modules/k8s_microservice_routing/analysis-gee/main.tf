...
resource "aws_api_gateway_resource" "v1_composite_service_geom_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_composite_service_resource.id
  path_part   = "geom"
}
...
resource "aws_api_gateway_resource" "v1_geodescriber_geom_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_geodescriber_resource.id
  path_part   = "geom"
}
...
resource "aws_api_gateway_resource" "v1_umd_loss_gain_use_name_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_umd_loss_gain_use_resource.id
  path_part   = "{name}"
}
...
resource "aws_api_gateway_resource" "v1_umd_loss_gain_use_name_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_umd_loss_gain_use_name_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v1_umd_loss_gain_wdpa_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_umd_loss_gain_wdpa_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v1_whrc_biomass_use_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_whrc_biomass_resource.id
  path_part   = "use"
}
...
resource "aws_api_gateway_resource" "v1_whrc_biomass_use_name_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_whrc_biomass_use_resource.id
  path_part   = "{name}"
}
...
resource "aws_api_gateway_resource" "v1_whrc_biomass_use_name_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_whrc_biomass_use_name_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v1_whrc_biomass_wdpa_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_whrc_biomass_wdpa_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v1_whrc_biomass_admin_iso_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_whrc_biomass_admin_resource.id
  path_part   = "{iso}"
}
...
resource "aws_api_gateway_resource" "v1_whrc_biomass_admin_iso_admin_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_whrc_biomass_admin_iso_resource.id
  path_part   = "{admin}"
}
...
resource "aws_api_gateway_resource" "v1_whrc_biomass_admin_iso_admin_admin2_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_whrc_biomass_admin_iso_admin_resource.id
  path_part   = "{admin2}"
}
...
resource "aws_api_gateway_resource" "v1_mangrove_biomass_use_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_mangrove_biomass_resource.id
  path_part   = "use"
}
...
resource "aws_api_gateway_resource" "v1_mangrove_biomass_use_name_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_mangrove_biomass_use_resource.id
  path_part   = "{name}"
}
...
resource "aws_api_gateway_resource" "v1_mangrove_biomass_use_name_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_mangrove_biomass_use_name_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v1_mangrove_biomass_wdpa_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_mangrove_biomass_wdpa_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v1_mangrove_biomass_admin_iso_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_mangrove_biomass_admin_resource.id
  path_part   = "{iso}"
}
...
resource "aws_api_gateway_resource" "v1_mangrove_biomass_admin_iso_admin_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_mangrove_biomass_admin_iso_resource.id
  path_part   = "{admin}"
}
...
resource "aws_api_gateway_resource" "v1_mangrove_biomass_admin_iso_admin_admin2_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_mangrove_biomass_admin_iso_admin_resource.id
  path_part   = "{admin2}"
}
...
resource "aws_api_gateway_resource" "v1_population_use_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_population_resource.id
  path_part   = "use"
}
...
resource "aws_api_gateway_resource" "v1_population_use_name_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_population_use_resource.id
  path_part   = "{name}"
}
...
resource "aws_api_gateway_resource" "v1_population_use_name_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_population_use_name_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v1_population_wdpa_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_population_wdpa_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v1_population_admin_iso_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_population_admin_resource.id
  path_part   = "{iso}"
}
...
resource "aws_api_gateway_resource" "v1_population_admin_iso_admin_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_population_admin_iso_resource.id
  path_part   = "{admin}"
}
...
resource "aws_api_gateway_resource" "v1_population_admin_iso_admin_admin2_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_population_admin_iso_admin_resource.id
  path_part   = "{admin2}"
}
...
resource "aws_api_gateway_resource" "v1_soil_carbon_use_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_soil_carbon_resource.id
  path_part   = "use"
}
...
resource "aws_api_gateway_resource" "v1_soil_carbon_use_name_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_soil_carbon_use_resource.id
  path_part   = "{name}"
}
...
resource "aws_api_gateway_resource" "v1_soil_carbon_use_name_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_soil_carbon_use_name_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v1_soil_carbon_wdpa_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_soil_carbon_wdpa_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v1_soil_carbon_admin_iso_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_soil_carbon_admin_resource.id
  path_part   = "{iso}"
}
...
resource "aws_api_gateway_resource" "v1_soil_carbon_admin_iso_admin_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_soil_carbon_admin_iso_resource.id
  path_part   = "{admin}"
}
...
resource "aws_api_gateway_resource" "v1_soil_carbon_admin_iso_admin_admin2_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_soil_carbon_admin_iso_admin_resource.id
  path_part   = "{admin2}"
}
...
resource "aws_api_gateway_resource" "v1_forma250gfw_latest_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_forma250gfw_resource.id
  path_part   = "latest"
}
...
resource "aws_api_gateway_resource" "v1_forma250gfw_use_name_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_forma250gfw_use_resource.id
  path_part   = "{name}"
}
...
resource "aws_api_gateway_resource" "v1_forma250gfw_use_name_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_forma250gfw_use_name_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v1_forma250gfw_wdpa_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_forma250gfw_wdpa_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v1_forma250gfw_admin_iso_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_forma250gfw_admin_resource.id
  path_part   = "{iso}"
}
...
resource "aws_api_gateway_resource" "v1_forma250gfw_admin_iso_admin_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_forma250gfw_admin_iso_resource.id
  path_part   = "{admin}"
}
...
resource "aws_api_gateway_resource" "v1_forma250gfw_admin_iso_admin_admin2_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_forma250gfw_admin_iso_admin_resource.id
  path_part   = "{admin2}"
}
...
resource "aws_api_gateway_resource" "v1_biomass_loss_use_name_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_biomass_loss_use_resource.id
  path_part   = "{name}"
}
...
resource "aws_api_gateway_resource" "v1_biomass_loss_use_name_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_biomass_loss_use_name_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v1_biomass_loss_wdpa_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_biomass_loss_resource.id
  path_part   = "wdpa"
}
...
resource "aws_api_gateway_resource" "v1_biomass_loss_wdpa_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_biomass_loss_wdpa_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v1_biomass_loss_admin_iso_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_biomass_loss_admin_resource.id
  path_part   = "{iso}"
}
...
resource "aws_api_gateway_resource" "v1_biomass_loss_admin_iso_admin_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_biomass_loss_admin_iso_resource.id
  path_part   = "{admin}"
}
...
resource "aws_api_gateway_resource" "v1_biomass_loss_admin_iso_admin_admin2_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_biomass_loss_admin_iso_admin_resource.id
  path_part   = "{admin2}"
}
...
resource "aws_api_gateway_resource" "v1_lansat_tiles_year_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_lansat_tiles_resource.id
  path_part   = "{year}"
}
...
resource "aws_api_gateway_resource" "v1_lansat_tiles_year_z_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_lansat_tiles_year_resource.id
  path_part   = "{x}"
}
...
resource "aws_api_gateway_resource" "v1_lansat_tiles_year_z_x_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_lansat_tiles_year_z_resource.id
  path_part   = "{x}"
}
...
resource "aws_api_gateway_resource" "v1_lansat_tiles_year_z_x_y_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_lansat_tiles_year_z_x_resource.id
  path_part   = "{y}"
}
...
resource "aws_api_gateway_resource" "v1_recent_tiles_tiles_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v1_recent_tiles_resource.id
  path_part   = "tiles"
}
...
resource "aws_api_gateway_resource" "v2_nlcd_landcover_use_name_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_nlcd_landcover_use_resource.id
  path_part   = "{name}"
}
...
resource "aws_api_gateway_resource" "v2_nlcd_landcover_use_name_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_nlcd_landcover_use_name_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v2_nlcd_landcover_wdpa_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_nlcd_landcover_resource.id
  path_part   = "wdpa"
}
...
resource "aws_api_gateway_resource" "v2_nlcd_landcover_wdpa_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_nlcd_landcover_wdpa_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v2_nlcd_landcover_admin_iso_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_nlcd_landcover_admin_resource.id
  path_part   = "{iso}"
}
...
resource "aws_api_gateway_resource" "v2_nlcd_landcover_admin_iso_admin_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_nlcd_landcover_admin_iso_resource.id
  path_part   = "{admin}"
}
...
resource "aws_api_gateway_resource" "v2_nlcd_landcover_admin_iso_admin_admin2_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_nlcd_landcover_admin_iso_admin_resource.id
  path_part   = "{admin2}"
}
...
resource "aws_api_gateway_resource" "v2_biomass_loss_use_name_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_biomass_loss_use_resource.id
  path_part   = "{name}"
}
...
resource "aws_api_gateway_resource" "v2_biomass_loss_use_name_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_biomass_loss_use_name_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v2_biomass_loss_wdpa_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_biomass_loss_resource.id
  path_part   = "wdpa"
}
...
resource "aws_api_gateway_resource" "v2_biomass_loss_wdpa_id_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_biomass_loss_wdpa_resource.id
  path_part   = "{id}"
}
...
resource "aws_api_gateway_resource" "v2_biomass_loss_admin_iso_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_biomass_loss_admin_resource.id
  path_part   = "{iso}"
}
...
resource "aws_api_gateway_resource" "v2_biomass_loss_admin_iso_admin_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_biomass_loss_admin_iso_resource.id
  path_part   = "{admin}"
}
...
resource "aws_api_gateway_resource" "v2_biomass_loss_admin_iso_admin_admin2_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_biomass_loss_admin_iso_admin_resource.id
  path_part   = "{admin2}"
}
...
resource "aws_api_gateway_resource" "v2_lansat_tiles_year_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_lansat_tiles_resource.id
  path_part   = "{year}"
}
...
resource "aws_api_gateway_resource" "v2_lansat_tiles_year_z_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_lansat_tiles_year_resource.id
  path_part   = "{x}"
}
...
resource "aws_api_gateway_resource" "v2_lansat_tiles_year_z_x_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_lansat_tiles_year_z_resource.id
  path_part   = "{x}"
}
...
resource "aws_api_gateway_resource" "v2_lansat_tiles_year_z_x_y_resource" {
  rest_api_id = var.api_gateway.id
  parent_id   = data.aws_api_gateway_resource.v2_lansat_tiles_year_z_x_resource.id
  path_part   = "{y}"
}
...
module "analysis_gee_get_v1_recent_tiles_classifier" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/recent-tiles-classifier"
...
module "analysis_gee_get_v1_composite_service" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/composite-service"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_composite_service_geom" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/composite-service/geom"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_post_v1_mc_analysis" {
  ...
  method         = "POST"
  uri            = "http://api.resourcewatch.org:30502/api/v1/mc-analysis"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_geodescriber" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/geodescriber"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_geodescriber_geom" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/geodescriber/geom"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_umd_loss_gain" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/umd-loss-gain"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_umd_loss_gain_use_name_id" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/umd-loss-gain/use/{name}/{id}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_umd_loss_gain_wdpa_id" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/umd-loss-gain/wdpa/{id}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_whrc_biomass" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/whrc-biomass"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_whrc_biomass_use_name_id" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/whrc-biomass/wdpa/{id}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_whrc_biomass_admin_iso" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/whrc-biomass/admin/{iso}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_whrc_biomass_admin_iso_admin" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/whrc-biomass/admin/{iso}/{admin}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_whrc_biomass_admin_iso_admin_admin2" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/whrc-biomass/admin/{iso}/{admin}/{admin2}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_mangrove_biomass" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/mangrove-biomass"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_mangrove_biomass_use_name_id" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/mangrove-biomass/wdpa/{id}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_mangrove_biomass_admin_iso" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/mangrove-biomass/admin/{iso}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_mangrove_biomass_admin_iso_admin" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/mangrove-biomass/admin/{iso}/{admin}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_mangrove_biomass_admin_iso_admin_admin2" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/mangrove-biomass/admin/{iso}/{admin}/{admin2}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_population" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/population"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_population_use_name_id" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/population/wdpa/{id}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_population_admin_iso" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/population/admin/{iso}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_population_admin_iso_admin" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/population/admin/{iso}/{admin}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_population_admin_iso_admin_admin2" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/population/admin/{iso}/{admin}/{admin2}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_soil_carbon" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/soil-carbon"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_soil_carbon_use_name_id" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/soil-carbon/wdpa/{id}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_soil_carbon_admin_iso" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/soil-carbon/admin/{iso}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_soil_carbon_admin_iso_admin" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/soil-carbon/admin/{iso}/{admin}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_soil_carbon_admin_iso_admin_admin2" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/soil-carbon/admin/{iso}/{admin}/{admin2}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_forma250gfw" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/forma250gfw"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_forma250gfw_use_name_id" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/forma250gfw/wdpa/{id}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_forma250gfw_admin_iso" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/forma250gfw/admin/{iso}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_forma250gfw_admin_iso_admin" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/forma250gfw/admin/{iso}/{admin}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_forma250gfw_admin_iso_admin_admin2" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/forma250gfw/admin/{iso}/{admin}/{admin2}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_biomass_loss" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/biomass-loss"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_biomass_loss_use_name_id" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/biomass-loss/wdpa/{id}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_biomass_loss_admin_iso" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/biomass-loss/admin/{iso}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_biomass_loss_admin_iso_admin" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/biomass-loss/admin/{iso}/{admin}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_biomass_loss_admin_iso_admin_admin2" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/biomass-loss/admin/{iso}/{admin}/{admin2}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_loss_by_landcover" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/loss-by-landcover"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_landcover" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/landcover"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v2_nlcd_landcover" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v2/nlcd-landcover"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v2_nlcd_landcover_use_name_id" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v2/nlcd-landcover/wdpa/{id}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v2_nlcd_landcover_admin_iso" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v2/nlcd-landcover/admin/{iso}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v2_nlcd_landcover_admin_iso_admin" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v2/nlcd-landcover/admin/{iso}/{admin}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v2_nlcd_landcover_admin_iso_admin_admin2" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v2/nlcd-landcover/admin/{iso}/{admin}/{admin2}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v2_biomass_loss" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v2/biomass-loss"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v2_biomass_loss_use_name_id" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v2/biomass-loss/wdpa/{id}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v2_biomass_loss_admin_iso" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v2/biomass-loss/admin/{iso}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v2_biomass_loss_admin_iso_admin" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v2/biomass-loss/admin/{iso}/{admin}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v2_biomass_loss_admin_iso_admin_admin2" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v2/biomass-loss/admin/{iso}/{admin}/{admin2}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_lansat_tiles_year_z_x_y" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/landsat-tiles/{year}/{z}/{x}/{y}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v2_lansat_tiles_year_z_x_y" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v2/landsat-tiles/{year}/{z}/{x}/{y}"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_sentinel_tiles" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/sentinel-tiles"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_get_v1_recent_tiles" {
  ...
  method         = "GET"
  uri            = "http://api.resourcewatch.org:30502/api/v1/recent-tiles"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_post_v1_recent_tiles_tiles" {
  ...
  method         = "POST"
  uri            = "http://api.resourcewatch.org:30502/api/v1/recent-tiles/tiles"
  vpc_link       = var.vpc_link
}
...
module "analysis_gee_post_v1_recent_tiles_thumbs" {
  ...
  api_resource   = aws_api_gateway_resource.v1_recent_tiles_tiles_resource
  method         = "POST"
  uri            = "http://api.resourcewatch.org:30502/api/v1/recent-tiles/thumbs"
  vpc_link       = var.vpc_link
}